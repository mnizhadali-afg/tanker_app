...
const LEVELS = ['customer', 'contract', 'invoice'] as const
...
export default function PaymentFormPage() {
  ...
  const [level, setLevel] = useState<typeof LEVELS[number]>('customer')
  ...
  const [payerAccountId] = useState('')
  const [payeeAccountId] = useState('')
  ...
  useEffect(() => {
    if (level === 'contract' || level === 'invoice') {
      api.get(`/contracts?customerId=${customerId}`).then((r) => setContracts(r.data))
    }
  }, [level, customerId])
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-xl p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <select value={paymentType} onChange={(e) => setPaymentType(e.target.value as typeof PAYMENT_TYPES[number])} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
          ...
          <div>
            ...
            <select value={level} onChange={(e) => setLevel(e.target.value as typeof LEVELS[number])} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
        ...
        {(level === 'contract' || level === 'invoice') && (
          <div>
            ...
            <select value={contractId} onChange={(e) => setContractId(e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
        ...
        {level === 'invoice' && (
          <div>
            ...
            <select value={invoiceId} onChange={(e) => setInvoiceId(e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
        ...
        <div>
          ...
          <select value={monetaryAccountId} onChange={(e) => setMonetaryAccountId(e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="number" value={amountAfn} onChange={(e) => setAmountAfn(e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">{t('payments.amountUsd')}</label>
            <input type="number" value={amountUsd} onChange={(e) => setAmountUsd(e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
        </div>
        ...
        {paymentType === 'exchange' && (
          <div>
            ...
            <input type="number" value={exchangeRate} onChange={(e) => setExchangeRate(e.target.value)} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
          </div>
        )}

        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">{t('payments.transactionDate')}</label>
          <input type="date" value={transactionDate} onChange={(e) => setTransactionDate(e.target.value)} required className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500" />
        </div>
